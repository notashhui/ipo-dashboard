...
export function StockDetail({ 
  ...
  return (
    <div
      className="w-full min-w-0 max-w-full overflow-x-hidden min-h-screen bg-black text-white pb-28"
    ...
    >
      ...
      {/* Fixed Bottom Trading Bar - Portal to body so it always fills viewport width */}
      {mounted &&
        createPortal(
          <div
